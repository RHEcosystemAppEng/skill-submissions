...
description: 'Analyze execution risk by classifying inventory, scanning extra_vars
  for secrets, and assessing scope.
  ...
  NOT for: launching jobs (use governed-job-launcher) or troubleshooting failures
  (use job-failure-analyzer).
