...
description: 'Query and display Red Hat Lightspeed managed system inventory. This
  skill focuses on discovery and listing only - for remediation actions, transition
  to the `/remediation` skill.
  ...
  **When NOT to use this skill** (use `/remediation` skill instead):
  ...
  This skill orchestrates MCP tools from lightspeed-mcp for fleet visibility and system
