...
description: 'Execute governed job launches with check mode, approval gates, phased
  ...
  NOT for: risk analysis (use execution-risk-analyzer first) or troubleshooting (use
