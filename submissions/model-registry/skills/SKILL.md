---
name: model-registry
description: 'Register, version, and manage ML models in the OpenShift AI Model Registry.
  Browse the Model Catalog, track model metadata, and promote models across environments.
  ...
  Handles model registration, versioning, metadata management, artifact tracking,
  and cross-environment promotion.
