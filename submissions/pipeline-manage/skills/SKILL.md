...
description: 'Create, run, schedule, and monitor Data Science Pipelines (Kubeflow
  Pipelines 2.0) on OpenShift AI.
  ...
  Handles pipeline server setup, pipeline run submission from YAML, scheduling recurring
  runs, monitoring execution, and viewing step logs.
