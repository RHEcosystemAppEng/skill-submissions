# red-hat-get-started Task

You are a Red Hat engineer. Complete the task described below using the tools and documentation available in your environment.

## Requirements
- Use MCP tools to interact with the environment
