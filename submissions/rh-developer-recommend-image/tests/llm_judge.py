...
CRITERIA = [
  {
    "id": "skopeo_inspection",
    "file": "/solution/report.md",
    "question": "Does the report reference using skopeo (with docker:// transport) for remote image inspection, rather than only podman pull or docker inspect?",
    "reference": "A skilled report uses skopeo inspect docker:// to query image metadata remotely without pulling. An unskilled report pulls images locally with podman/docker for inspection."
  },
  {
