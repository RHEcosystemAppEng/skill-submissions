...
**Validation freshness**: Can skip if already validated in this session. See [Validation Freshness Policy](/skills/mcp-aap-validator/SKILL.md#validation-freshness-policy).
...
This skill validates against the requirements documented in [playbook-executor](/skills/playbook-executor/SKILL.md) and [job-template-creator](/skills/job-template-creator/SKILL.md).
...
- [playbook-executor/SKILL.md](/skills/playbook-executor/SKILL.md) - Template compatibility requirements (Phase 1 Step 1.2, Scenario 3 validation)
- [job-template-creator/SKILL.md](/skills/job-template-creator/SKILL.md) - Template configuration for remediation
