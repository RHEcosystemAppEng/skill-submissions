...
When invoked from the [playbook-executor](/skills/playbook-executor/SKILL.md) skill (Scenario 3 - No suitable template), this skill receives playbook content in context. The playbook-executor invokes with an instruction such as:
...
**Note**: Can skip if validation was performed earlier in this session and succeeded. See [Validation Freshness Policy](/skills/mcp-aap-validator/SKILL.md#validation-freshness-policy).
