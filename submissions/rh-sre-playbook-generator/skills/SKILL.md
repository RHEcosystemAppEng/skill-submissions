...
- [cve-remediation-templates.md](/workspace/supportive/docs/ansible/cve-remediation-templates.md) - Ansible playbook templates for different CVE types
- [package-management.md](/workspace/supportive/docs/rhel/package-management.md) - RHEL package management best practices (DNF vs YUM, reboot detection)
