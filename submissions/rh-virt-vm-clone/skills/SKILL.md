...
- **Action**: Read [storage-errors.md](/workspace/supportive/docs/troubleshooting/storage-errors.md) for VM cloning failures, storage provisioning, DataVolume errors
- **Output to user**: "I consulted [storage-errors.md](/workspace/supportive/docs/troubleshooting/storage-errors.md) to understand potential causes."
...
**Troubleshooting** (see [storage-errors.md](/workspace/supportive/docs/troubleshooting/storage-errors.md)):
...
- [storage-errors.md](/workspace/supportive/docs/troubleshooting/storage-errors.md) - VM cloning failure scenarios, storage provisioning issues, and DataVolume cloning errors (optionally consulted when cloning operations fail)
- [Troubleshooting INDEX](/workspace/supportive/docs/troubleshooting/INDEX.md) - Navigation hub for discovering additional error categories when encountering unexpected issues outside the categories above
