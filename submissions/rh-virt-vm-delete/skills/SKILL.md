...
**OPTIONAL**: Read [storage-errors.md](/workspace/supportive/docs/troubleshooting/storage-errors.md) for PVC cleanup. Output: "Consulted storage-errors.md for failure."
...
**OPTIONAL**: Read [lifecycle-errors.md](/workspace/supportive/docs/troubleshooting/lifecycle-errors.md) for deletion failures. Output: "Consulted lifecycle-errors.md for failure causes."
...
**Solution**: Consult [lifecycle-errors.md](/workspace/supportive/docs/troubleshooting/lifecycle-errors.md) "VM Stuck in Terminating" for MCP-first approach using `resources_get` to check finalizers, `resources_create_or_update` to remove if needed.

### Issue 4: Storage Deletion Failure
**Error**: "PVC deletion failed: resource in use"
**Solution**: Verify VM deleted first. Consult [storage-errors.md](/workspace/supportive/docs/troubleshooting/storage-errors.md) for MCP-first diagnostics using `pods_list_in_namespace` to check mounts, `resources_get` for PVC status.
...
- [lifecycle-errors.md](/workspace/supportive/docs/troubleshooting/lifecycle-errors.md) - Deletion failures, finalizers, stuck Terminating (consulted on deletion failure)
- [storage-errors.md](/workspace/supportive/docs/troubleshooting/storage-errors.md) - Storage deletion, PVC cleanup (consulted on storage failure)
- [Troubleshooting INDEX](/workspace/supportive/docs/troubleshooting/INDEX.md) - Full error index
